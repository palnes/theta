  ...
  return (
    ...
    return (
      <div
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.zIndex = 'calc(var(--sys-zindex-tooltip) + 1)';
          e.currentTarget.style.transform = 'scale(1.05)';
          e.currentTarget.style.boxShadow = '0 8px 24px rgba(0, 0, 0, 0.25)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.zIndex = `var(--sys-zindex-${key})`;
...
{`.backdrop {
  z-index: var(--sys-zindex-modal);
}

.modal {
  z-index: calc(var(--sys-zindex-modal) + 1);
}`}
    </pre>
  </div>
